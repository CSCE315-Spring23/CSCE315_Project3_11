...
VALUES ('Gyro', 8.09, to_jsonb(ARRAY['Bowl']), to_jsonb(ARRAY['Shredded Lettuce', 'Spinach', 'Brown Rice', 'White Rice', 'Chicken', 'Lamb', 'Beef', 'Pork', 'Couscous', 'Onions', 'Big Tomatoes', 'Vegetable Medley', 'Olives', 'Piclked Onions', 'Cucumbers', 'Cauliflower', 'Peppers', 'Red Cabbage Coleslaw', 'Garlic Fries', 'Jalapeno Feta', 'Tzatziki', 'Greek Vinaigrette', 'Harrisa Yogurt', 'Dill Yogurt', 'Tahini']));
INSERT INTO "MenuItems" ("ItemName", "Price", "DefiniteItems", "PossibleItems") 
